...
I build ambitious software end-to-end — from a **bare-metal operating system** to **full-stack AI products** and **polished native iOS apps**. I like going deep: writing my own TrueType font rasterizer, wiring real billing into a SaaS, and shipping apps on Apple's newest frameworks.
...
**Languages:** TypeScript · Swift · C · JavaScript · Python
**Web / Backend:** React · Vite · Node.js · WebSocket · Docker · Firebase · Stripe
...
<sub>Building, breaking, and learning in public. ✦</sub>